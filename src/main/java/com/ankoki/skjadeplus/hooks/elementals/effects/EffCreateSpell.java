package com.ankoki.skjadeplus.hooks.elementals.effects;
...
public class EffCreateSpell extends Effect {
    ...
    protected void execute(Event event) {
        ...
        if (name == null) return;
        if (generic) {
            ElementalsAPI.registerGenericSpells(SkJadePlus.getInstance(), new GenericSpell() {
        ...
        ElementalsAPI.registerEntitySpells(SkJadePlus.getInstance(), new EntitySpell() {
            private final Spell spell = new Spell(name, i, false);
            @Override
