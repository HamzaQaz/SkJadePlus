...
@Name("Image Lines")
@Description("Returns all the lines to make up an image. Max width is 150 and the image should be in the SkJadePlus plugin folder.")
    ...
    protected String[] get(Event e) {
        ...
        try {
            ...
            if (fromUrl) {
                ...
                File file = new File(SkJadePlus.getInstance().getDataFolder() + File.separator + name);
