...
public class Config {
    ...
    public static boolean PROTOCOL_LIB_ENABLED, HOLOGRAPHIC_DISPLAYS_ENABLED, ELEMENTALS_ENABLED, VERSION_ALERTS, DISABLE_UPDATE_CHECKER;

    private final SkJadePlus plugin;

    private FileConfiguration config;
    private File cfile;

    public Config(SkJadePlus plugin) {
        this.plugin = plugin;
        reloadConfig();
    }
    ...
    private void loadFile() {
        ...
        DISABLE_UPDATE_CHECKER = config.getBoolean("disable-update-checker");
    }
}
